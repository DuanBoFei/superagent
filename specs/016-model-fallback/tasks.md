...
- [ ] T001 [BE] Add `tests/models/fallback-policy.test.ts` for timeout fallback decision  
...
- [ ] T002 [BE] Add policy test for 5xx primary retry then fallback  
  Source: FR-MF-02, FR-MF-05 · Input: 5xx error + attempt count · Output: retry then fallback · Verify: same test file

- [ ] T003 [BE] Add policy test for 400/401/403 terminal errors  
  Source: FR-MF-03 · Input: non-retryable status · Output: fail decision · Verify: same test file

- [ ] T004 [BE] Create `src/models/fallback-policy.ts` with minimal decision function  
...
- [ ] T005 [BE] Add provider error classification test for HTTP 429/5xx  
...
- [ ] T006 [BE] Add provider error classification test for HTTP 400/401  
  Source: FR-MF-03 · Input: fake response status · Output: terminal category · Verify: same test file

- [ ] T007 [BE] Normalize provider thrown errors with status/category fields  
  Source: FR-MF-02, FR-MF-03 · Input: provider failure · Output: categorized error · Verify: provider fallback tests

- [ ] T008 [BE] Add timeout error mapping in model client/provider boundary  
