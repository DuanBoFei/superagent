...
- [ ] T017 [DOC] Add Windows manual smoke checklist to feature session notes  
  Source: FR-CW-09 · Input: Windows terminal steps · Output: repeatable checklist · Verify: file exists

- [ ] T018 [INT] Run `pnpm start -- --prompt "hello"` smoke  
  Source: FR-CW-03 · Input: one-shot prompt · Output: response then exit · Verify: manual command output
