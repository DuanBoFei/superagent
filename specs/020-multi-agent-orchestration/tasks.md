...
| T021 | Add observability event type definitions | [BE] | T020 | ✅ `pnpm test -- tests/observability/agent-events.test.ts` |
...
| T027 | Add CLI rendering label for multi-agent phase starts | [FE] | T020 | ✅ `pnpm test -- tests/cli/one-shot.test.ts` |
| T028 | Add one-shot smoke with `/multi-agent` and fake provider | [INT] | T024 | ✅ `pnpm test -- tests/runtime/multi-agent-integration.test.ts tests/cli/one-shot.test.ts` |
| T029 | Run focused test suite | [INT] | T001-T028 | ✅ `pnpm test -- tests/cli/one-shot.test.ts tests/runtime/multi-agent-integration.test.ts tests/agents tests/observability/agent-events.test.ts`; ✅ `pnpm typecheck` |
