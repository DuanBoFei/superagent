...
export function CopyButton({ rawContent, onCopy }: CopyButtonProps) {
  return (
    <button
      type="button"
      className="terminal-copy-btn text-xs text-neutral-500 hover:text-neutral-200 bg-neutral-800 hover:bg-neutral-700 rounded px-2 py-1 transition-colors absolute top-2 right-2 z-10"
